import profilePic from "../assets/Bharath_photo.jpg"
      ...
      <div className="flex flex-wrap lg:flex-row-reverse">
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center lg:p-8">
            <motion.img
              src={profilePic}
              alt="Bharath Raghavan" className="border border-stone-900 rounded-3xl"
              width={650}
              height={650}
          ...
          <motion.div 
            ...
            <motion.h2
              variants={childVariants}
               className="pb-2 text-4xl tracking-tighter lg;text-8xl">Bharath Raghavan
            </motion.h2>
            <motion.span 
            variants={childVariants}
